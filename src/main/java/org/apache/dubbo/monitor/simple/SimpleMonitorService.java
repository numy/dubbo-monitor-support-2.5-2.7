...
public class SimpleMonitorService implements MonitorService,com.alibaba.dubbo.monitor.MonitorService {
    ...
    private static final String[] types = {org.apache.dubbo.monitor.MonitorService.SUCCESS, org.apache.dubbo.monitor.MonitorService.FAILURE,
            org.apache.dubbo.monitor.MonitorService.ELAPSED, org.apache.dubbo.monitor.MonitorService.CONCURRENT,
            org.apache.dubbo.monitor.MonitorService.MAX_ELAPSED,
            org.apache.dubbo.monitor.MonitorService.MAX_CONCURRENT};
    ...
    private void write() throws Exception {
        ...
        for (String key : types) {
            try {
                ...
                String consumer;
                String provider;
                if (statistics.hasParameter(org.apache.dubbo.monitor.MonitorService.PROVIDER)) {
                    type = org.apache.dubbo.monitor.MonitorService.CONSUMER;
                    consumer = statistics.getHost();
                    provider = statistics.getParameter(org.apache.dubbo.monitor.MonitorService.PROVIDER);
                    int i = provider.indexOf(':');
                    if (i > 0) {
                        provider = provider.substring(0, i);
                    }
                } else {
                    type = org.apache.dubbo.monitor.MonitorService.PROVIDER;
                    consumer = statistics.getParameter(org.apache.dubbo.monitor.MonitorService.CONSUMER);
                ...
                String filename = statisticsDirectory
                        ...
                        + "/" + statistics.getParameter(org.apache.dubbo.monitor.MonitorService.METHOD)
                        + "/" + consumer
                        + "/" + provider
                        + "/" + type + "." + key;
    ...
    @Override
    public List<com.alibaba.dubbo.common.URL> lookup(com.alibaba.dubbo.common.URL query) {
        return null;
    }
}